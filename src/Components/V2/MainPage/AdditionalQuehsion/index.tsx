...
export const AdditionalQuehsion: FC = () => {
    return (
        <Box sx={{width:'100%', display:'flex', flexWrap:'wrap', justifyContent:'center', rowGap:'20px'}}>
            ...
            <div style={{width:'100%', display:'flex', flexWrap:'wrap', justifyContent:'center', columnGap:'40px', rowGap:'5px'}}>

            <Typography id='defaultText' variant="subtitle2" gutterBottom style={{textAlign:'left',width:'40%'}}>
            ...
            <Typography id='defaultText' variant="subtitle2" gutterBottom style={{textAlign:'left',width:'86%'}}>
